    ...
    */
    ...
    doSave (e) {
        ...
        this._doSubmit(() => {
            ...
            this.props.doAdd(this.state.context, ViewComponent, () => {
                this.closeModal()
            })
        })
    }
                    ...
                    <Form onSubmit={this.doSave} className='IEditItem'>
                        ...
                        <Row className="InfernoFormlib-ActionBar">
                            <Col>
                                ...
                                <a href="#" onClick={this.doNotAdd}>Ångra</a>
                            </Col>
                        </Row>
                    </Form>
                </ModalBody>
...
var YoutubeWidgetUtility = createUtility({
    ...
    add: function (doAdd, onClose) {
        // Open a modal and allow user to enter data
        var ViewComponent = this.Component;

        // onClose = () => {}
        
        return <YoutubeWidgetModal doAdd={doAdd} ViewComponent={this.Component} onClose={onClose} />
    },
    
    Component: class YoutubeWidget extends Component {
        constructor () {
            super(...arguments)
            this.state= {

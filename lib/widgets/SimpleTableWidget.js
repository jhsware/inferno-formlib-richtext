...
var SimpleTableWidgetModal = React.createClass({
    ...
    render: function () {
        ...
        var ActionButton = registry.getUtility(IActionButtonWidget).Component;
        var ActionBar = registry.getUtility(IActionBarWidget).Component;
...
var SimpleTableWidgetUtility = createUtility({
    ...
    add: function (currentUser, doAdd) {
        ...
        var ViewComponent = this.Component;
        
        global.dispatcher.dispatch({
            actionType: 'showModal',
            // modal: <SimpleTableWidgetModal doAdd={doAdd} ViewComponent={this.Component}/>
            modal: <SimpleTableWidgetModal onAdd={doAdd} ViewComponent={this.Component} />
        });
    },

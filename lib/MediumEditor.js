...
class MediumEditor extends Component {
    ...
    doChangeBlockElement (tagName, opt) {
        ...
        els.forEach(el => el.classList.remove("placeCaretHereNow"))
    ...
    doAddWidget (utilityName, opt) {
        ...
        var currentSelectionRange = getCurrentSelectionRange()
        ...
        widgetUtil.add(this.context.currentUser, (data, ViewComponent, callback) => {
            ...
            var selBoundEl = getSelectionBoundaryElement(true)
            var blockEl = getBlockEl(editorEl, selBoundEl)
